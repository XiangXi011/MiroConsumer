...
import { buildPropagationTimelineItems } from '../src/utils/channelPropagation.js'
...
test('PropagationTimeline.vue is mounted by Step4Report', () => {
  ...
  for (const label of ['Initial reaction', 'Claim amplification', 'Objection emergence', 'Misread spread', 'Evidence repair']) {
