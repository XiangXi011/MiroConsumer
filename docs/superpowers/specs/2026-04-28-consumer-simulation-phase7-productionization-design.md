...
| 7F | [phase7f-acceptance-regression-design.md](2026-04-29-consumer-simulation-phase7f-acceptance-regression-design.md) | whole-phase smoke、golden case regression、rollback gates、CI gates |
...
3. 前端 node 测试通过。
4. 前端 build 通过。
5. `docker compose -f docker-compose.prod.yml config` 通过。
