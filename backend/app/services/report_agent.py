...
from .report_consumer_mixin import ConsumerReportMixin
from .report_tool_mixin import ReportToolMixin
...
class ReportAgent(ConsumerReportMixin, ReportToolMixin):
    """
